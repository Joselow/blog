...
<head>
  ...
  <script async type="module" crossorigin src="./assets/compiled/js/layout-rtl-backup.js"></script>
  <link rel="stylesheet" href=" {{asset('dash/css/layout-rtl-backup.css')}}">
  <link rel="stylesheet" href="{{asset('dash/css/app-dark.css')}}">
